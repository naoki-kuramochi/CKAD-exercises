...
<details><summary>show</summary>
<p>
ポッドYAMLで「nodeSelector」プロパティを使用できます。  
see: https://cloud.google.com/kubernetes-engine/docs/concepts/node-pools
